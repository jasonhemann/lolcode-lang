...
def parser(lexeme_dictionary):
    ...
    # loops thru the lexemes, find the HAI
    # find_hai = list(lexeme_dictionary.keys()).index("HAI")

    # starting from HAI
    # for lexeme in list(lexeme_dictionary.keys())[find_hai:]:
    #     value = lexeme_dictionary[lexeme]
    #     print(f"Key: {lexeme}, Value: {value}")

    #     # if the code does not end in KTHXBYE
    #     if list(lexeme_dictionary.keys())[-1] != 'KTHXBYE':
    #         result.append("SYNTAX ERROR: Expected KTHXBYE")
    #         print("SYNTAX ERROR: Expected KTHXBYE")
    #         break

    #     if lexeme == 'PRODUCKT OF':
    #         index = list(lexeme_dictionary.keys()).index(lexeme)
    #         if lexeme_dictionary[list(lexeme_dictionary.keys())[index+1]] == 'NUMBR Literal':
    #             result.append("SYNTAX ERROR: Expected NUMBR Literal")
    #             print("SYNTAX ERROR: Expected NUMBR Literal")
    #             break
    #         elif lexeme_dictionary[list(lexeme_dictionary.keys())[index+1]] == 'NUMBAR Literal':
    #             result.append("SYNTAX ERROR: Expected NUMBAR Literal")
    #             print("SYNTAX ERROR: Expected NUMBAR Literal")
    #             break
    #         elif lexeme_dictionary[list(lexeme_dictionary.keys())[index+1]] == 'YARN Literal':
    #             result.append("SYNTAX ERROR: Expected YARN Literal")
    #             print("SYNTAX ERROR: Expected YARN Literal")
    #             break
    #         elif lexeme_dictionary[list(lexeme_dictionary.keys())[index+1]] == 'TROOF Literal':
    #             result.append("SYNTAX ERROR: Expected TROOF Literal")
    #             print("SYNTAX ERROR: Expected TROOF Literal")
    #             break
    #         elif lexeme_dictionary[list(lexeme_dictionary.keys())[index+1]] == 'NOOB':
    #             result.append("SYNTAX ERROR: Expected NOOB")
    #             print("SYNTAX ERROR: Expected NOOB")
    #             break

parser(lexeme_dictionary)