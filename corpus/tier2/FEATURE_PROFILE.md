...
- Bugs extracted (candidate repro items): `422`
...
- Capture type: `implementation-only`
...
- Bugs extracted (candidate repro items): `46`
...
- Recovery state: `not-applicable`
- Capture type: `implementation+sample-code`
- Captured implementation files: `3`
- LOLCODE files: `3`
- Total LOLCODE lines: `49`
...
- Repo: `SADAsuncion/LOLCodeInterpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
- Repo: `DvaeFroot/cmsc124-lolcode-interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
- Repo: `justinmeza/httpd.lol`
- Kind: `corpus`
- Status: `seeded`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
- Capture type: `sample-only`
- Captured implementation files: `0`
- LOLCODE files: `1`
- Total LOLCODE lines: `82`
...
- Repo: `shaunlgs/lolcode-simple-algorithms`
- Kind: `corpus`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
- Repo: `theDrake/lolcode-experiments`
- Kind: `corpus`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
## lolcode-game-of-life

- Repo: `superkrzysio/lolcode-game-of-life`
- Kind: `corpus`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
- Repo: `SomeUnusualGames/Flag-Wars-3-LOLCODE`
- Kind: `corpus`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
- Repo: `seanpm2001/AI2001_Category-Source_Code-SC-LOLCODE`
- Kind: `corpus`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
- Repo: `mkkellogg/lolcode`
- Kind: `corpus`
- Status: `archive`
- Recovered from initially-missing set: `false`
- Recovery state: `initially-missing-unrecovered`
- Capture type: `none`
- Captured implementation files: `0`
- LOLCODE files: `0`
- Total LOLCODE lines: `0`
...
- Repo: `kartiknair/lolcode-interpreter`
- Kind: `interpreter`
- Status: `archive`
- Recovered from initially-missing set: `false`
- Recovery state: `initially-missing-unrecovered`
...
- Repo: `SHI2015/Lolcode-Interpreter`
- Kind: `interpreter`
- Status: `archive`
- Recovered from initially-missing set: `false`
- Recovery state: `initially-missing-unrecovered`
...
- Repo: `LorenzoPeri17/lolcode-interpreter`
- Kind: `interpreter`
- Status: `archive`
- Recovered from initially-missing set: `false`
- Recovery state: `initially-missing-unrecovered`
...
- Repo: `nicodecastro/lolcode-interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
- Repo: `bernardjezua/LOLCODE-Interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
- Capture type: `implementation+sample-code`
- Captured implementation files: `22`
- LOLCODE files: `11`
- Total LOLCODE lines: `497`
- Bugs extracted (candidate repro items): `0`
- Candidate core-1.2/1.3 repro items: `0`
- Candidate extension repro items: `0`
- Candidate unknown-scope repro items: `0`
...
## coleenagsao-python-lolcode-interpreter

- Repo: `coleenagsao/python-lolcode-interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `false`
- Recovery state: `not-applicable`
...
- Repo: `markwatkinson/loljs`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `true`
- Recovery state: `recovered-replacement-candidate`
- Capture type: `implementation+sample-code`
- Captured implementation files: `8`
- LOLCODE files: `2`
...
- Repo: `maadriana/lolcode-interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `true`
- Recovery state: `recovered-replacement-candidate`
...
- Repo: `garthendrich/lolcode-interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `true`
- Recovery state: `recovered-replacement-candidate`
...
- Repo: `nfenciso1/lolcode-interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `true`
- Recovery state: `recovered-replacement-candidate`
...
- Repo: `SallySanban/LOLCODE-Interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `true`
- Recovery state: `recovered-replacement-candidate`
...
- Repo: `kjdeluna/Lolcode-Interpreter`
- Kind: `interpreter`
- Status: `unverified`
- Recovered from initially-missing set: `true`
- Recovery state: `recovered-replacement-candidate`
- Capture type: `implementation-only`
- Captured implementation files: `34`
- LOLCODE files: `0`
- Total LOLCODE lines: `0`
- Bugs extracted (candidate repro items): `0`
- Candidate core-1.2/1.3 repro items: `0`
