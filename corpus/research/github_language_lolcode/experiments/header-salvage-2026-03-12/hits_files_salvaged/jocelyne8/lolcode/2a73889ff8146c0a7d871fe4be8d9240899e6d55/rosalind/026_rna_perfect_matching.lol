HAI 1.3  
  ...
  BTW ============================== MAIN ================================================
  I HAS A rna_sequence, GIMMEH rna_sequence
  
  BTW count A and C
  BTW m = count A = count U ; n = count C = count G
  I HAS A m ITZ 0, I HAS A n ITZ 0
  I HAS A i ITZ 0
  IM IN YR loop UPPIN YR i WILE DIFFRINT i AN BIGGR OF i AN LEN OF rna_sequence
    rna_sequence!i, WTF?
      OMG "a", OMG "A", m R SUM OF m AN 1, GTFO
      OMG "c", OMG "C", n R SUM OF n AN 1, GTFO
    OIC
  IM OUTTA YR loop
  
  I HAS A mf ITZ FAKTORAL_BIG_NUMBR m
  I HAS A nf ITZ FAKTORAL_BIG_NUMBR n
  
  PRINTZ_BIG_NUMBR TIMES_BIG_NUMBRZ mf AN nf 
