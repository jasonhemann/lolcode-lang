...
Generated: `Monday, March 2nd, 2026 3:03:52pm`

## Totals

- Corpus files: `223`
- In-scope 1.3 files: `124`
- In-scope parse-ok files: `72`
- In-scope eval-ok files: `69`
- Promoted missing-version files: `111`
- Fixture files: `16`
...
- `loop-total`: `65`
- `loop-with-update`: `58`
- `loop-with-cond-wile`: `41`
- `if-with-else`: `37`
- `function-total`: `28`
- `loop-with-cond-til`: `16`
