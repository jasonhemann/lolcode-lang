...
- Canonical adjudication ledger:
  - `/Users/jhemann/Code/lolcode-lang/spec/traceability/ADJUDICATION_LEDGER.md`
- Direct regression-anchor index:
  - `/Users/jhemann/Code/lolcode-lang/spec/traceability/TEST_ANCHOR_INDEX.md`
  - Generated by: `racket scripts/generate_nxx_test_anchors.rkt`
...
|-------|--------------------|---------------------------------------------------------------------------------------|------------------------------------------------------|
| `N01` | implemented        | `src/lolcode/parser.rkt`, `src/lolcode/ast.rkt`                                       | `ADJUDICATION_LEDGER.md` row `N01` |
...
| `N20` | policy+implemented | `src/lolcode/runtime.rkt` (`omgwtf` memoization + strict zero-arity hook call + non-callable post-synthesis slot-call error`) | adjudication rows `N20` + `N20 (extended)`           |
...
| `N43` | implemented        | `src/lolcode/lexer.rkt`, `src/lolcode/parser.rkt`, `src/lolcode/runtime.rkt` (strict direct keyword reservation + dynamic-name `SRS` escape path)          | adjudication row `N43`                               |
...
| `N88` | implemented        | `src/lolcode/runtime.rkt` (SRS identifier-shape validation; nested SRS indirection; no generated-source reparsing)                     | adjudication row `N88`                               |
