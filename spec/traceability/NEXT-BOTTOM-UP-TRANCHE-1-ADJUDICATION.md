...
| `N40` | adjudicated | Argument evaluation order is deterministic left-to-right before function/method body entry (`function-call-arg-eval-order-src`, `method-call-arg-eval-order-src`). |
