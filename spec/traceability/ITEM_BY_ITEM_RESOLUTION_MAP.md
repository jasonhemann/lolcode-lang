...
- Canonical adjudication ledger:
  - `/Users/jhemann/Code/lolcode-lang/spec/traceability/EXPERT_REVIEW_ADJUDICATION_LEDGER.md`
- Direct regression-anchor index:
  - `/Users/jhemann/Code/lolcode-lang/spec/traceability/NXX_TEST_ANCHORS.md`
...
|-------|--------------------|---------------------------------------------------------------------------------------|------------------------------------------------------|
| `N01` | implemented        | `src/lolcode/parser.rkt`, `src/lolcode/ast.rkt`                                       | `EXPERT_REVIEW_ADJUDICATION_LEDGER.md` row `N01` |
